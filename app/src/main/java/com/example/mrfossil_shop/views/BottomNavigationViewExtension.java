...
public class BottomNavigationViewExtension extends BottomNavigationView {
// used for animation
    ...
    public BottomNavigationViewExtension(Context context) {
        super(context);
    }

    public BottomNavigationViewExtension(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BottomNavigationViewExtension(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param visibility
     */
    public BottomNavigationViewExtension setIconVisibility(boolean visibility) {
        /*
...
//                            System.out.println("mIcon.getMeasuredHeight():" + mIcon.getMeasuredHeight());
     ...
     * @param visibility
     */
    public BottomNavigationViewExtension setTextVisibility(boolean visibility) {
...
//            System.out.println("mLargeLabel.getMeasuredHeight():" + getFontHeight(mSmallLabelSize));
     ...
     */
    public BottomNavigationViewExtension enableAnimation(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//                System.out.println("mLargeLabel:" + mLargeLabelSize);
     ...
     */
    @Deprecated
    public BottomNavigationViewExtension enableShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     */
    @Deprecated
    public BottomNavigationViewExtension enableItemShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     *
     */
    public BottomNavigationViewExtension setCurrentItem(int index) {
     ...
     * @param sp
     */
    public BottomNavigationViewExtension setSmallTextSize(float sp) {
     ...
     * @param sp
     */
    public BottomNavigationViewExtension setLargeTextSize(float sp) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param sp
     */
    public BottomNavigationViewExtension setTextSize(float sp) {
        setLargeTextSize(sp);
        setSmallTextSize(sp);
        return this;
    }
     ...
     * @param height   in dp
     */
    public BottomNavigationViewExtension setIconSizeAt(int position, float width, float height) {
     ...
     * @param height in dp
     */
    public BottomNavigationViewExtension setIconSize(float width, float height) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param dpSize  in dp
     */
    public BottomNavigationViewExtension setIconSize(float dpSize) {
     ...
     * @param height in px
     */
    public BottomNavigationViewExtension setItemHeight(int height) {
        // 1. get mMenuView
        final BottomNavigationMenuView mMenuView = getBottomNavigationMenuView();
     ...
     */
    public BottomNavigationViewExtension setTypeface(Typeface typeface, int style) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @attr ref android.R.styleable#TextView_typeface
     */
    public BottomNavigationViewExtension setTypeface(Typeface typeface) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     */
    public BottomNavigationViewExtension setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
 ...
 * necessary calls back to the provided {@link BottomNavigationViewExtension} so that the tab position is
 * kept in sync.
 * <p>
...
private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
    private final WeakReference<BottomNavigationViewExtension> mBnveRef;

    public BottomNavigationViewExOnPageChangeListener(BottomNavigationViewExtension bnve) {
    ...
    public void onPageSelected(final int position) {
        final BottomNavigationViewExtension bnve = mBnveRef.get();
...
private static class MyOnNavigationItemSelectedListener implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavigationViewExtension bnve, boolean smoothScroll, BottomNavigationView.OnNavigationItemSelectedListener listener) {
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
    ...
    /*
    public BottomNavigationViewExtension enableShiftingMode(int position, boolean enable) {
        getBottomNavigationItemView(position).setShifting(enable);
        return this;
    }

    public BottomNavigationViewExtension setItemBackground(int position, int background) {
        getBottomNavigationItemView(position).setItemBackground(background);
        return this;
    }

    public BottomNavigationViewExtension setIconTintList(int position, ColorStateList tint) {
        getBottomNavigationItemView(position).setIconTintList(tint);
        return this;
    }

    public BottomNavigationViewExtension setTextTintList(int position, ColorStateList tint) {
    ...
    */
     ...
     */
    public BottomNavigationViewExtension setIconsMarginTop(int marginTop) {
     ...
     * @param marginTop in px
     */
    public BottomNavigationViewExtension setIconMarginTop(int position, int marginTop) {
        /*
